...
function submit()
{
    ...
    for (var j = 1; j <= 4; j++) 
    {
        var names_of_people = document.getElementById("name_of_the_student_"+j).value;
        console.log(name_of_people);
        name_of_people_array.push(name_of_the_student);
    }

    console.log(name_of_the_student_array);

    var lenght_of_name_of_people_array = name_of_the_student_array.length;
    console.log(lenght_of_name_of_people_array);

    for (var k = 0; k < lenght_of_name_of_people_array; k++) 
    {
        display_student_array.push("<h4>NAME - "+ name_of_the_people_array[k] + "</h4>");
...
function sorting()
	{
		...
		var lenght_of_names_of_people_array = name_of_people_array.length;
